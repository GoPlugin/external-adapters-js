...
import { util, Logger, AdapterConfigError, AdapterDataProviderError } from '@plugin/ea-bootstrap'
import abi from '@plugin/contracts/abi/v0.8/AggregatorV2V3Interface.json'
