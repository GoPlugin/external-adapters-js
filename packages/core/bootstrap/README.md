# Plugin External Adapter Bootstrap

> **Warning**
> This framework is deprecated, and all new adapters should be built with the [EA framework v3](https://github.com/goplugin/ea-framework-js).
...
- [Plugin External Adapter Bootstrap](#plugin-external-adapter-bootstrap)
...
- `{"id": 1, "data": {"base":"PLI", "quote": "USD"}}`
- `{"id": 2, "data": {"base":"PLI", "quote": "USD", "maxAge": 10000}}`
- `{"id": 3, "data": {"base":"PLI", "quote": "USD"}}`
...
- `{"id": 1, "data": {"base":"PLI", "quote": "USD", "timestamp": 1598874704}}`
- `{"id": 2, "data": {"base":"PLI", "quote": "USD", "timestamp": 1598874721}}`
