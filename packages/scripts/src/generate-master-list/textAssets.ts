...
export const compositeListDescription = `# Plugin Composite External Adapters
...
export const sourceListDescription = `# Plugin Source External Adapters

${genSig}`

export const targetListDescription = `# Plugin Target External Adapters

External Adapters that write data to a location, often a blockchain.

${genSig}`

export const nonDeployableListDescription = `# Plugin Non-deployable Adapters
