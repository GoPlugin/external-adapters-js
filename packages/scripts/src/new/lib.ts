...
export async function generate() {
  ...
  currentWorkspace = currentWorkspace.filter((w) => w.name !== '@plugin/ea-bootstrap') //filter out package
  currentWorkspace = currentWorkspace.filter((w) => w.name !== '@plugin/readme-test-adapter') //filter out package
