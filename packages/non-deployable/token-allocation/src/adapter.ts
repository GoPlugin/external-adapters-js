...
import type { AdapterRequest, APIEndpoint, ConfigFactory } from '@plugin/ea-bootstrap'
import { adaptersV2, adaptersV3, makeConfig as makeUpstreamConfig } from './config'
import { Config } from './types'
import * as types from '@plugin/ea-bootstrap'
import { AdapterImplementation as v2AdapterImplementation } from '@plugin/ea-bootstrap'
