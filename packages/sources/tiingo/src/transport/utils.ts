...
import { WebsocketTransportGenerics } from '@plugin/external-adapter-framework/transports'
import {
  WebsocketReverseMappingTransport,
  WebSocketTransport,
} from '@plugin/external-adapter-framework/transports/websocket'
import { config } from '../config'
import { splitArrayIntoChunks } from '@plugin/external-adapter-framework/util'
