import { AdapterRequest, AdapterResponse, Execute, Requester } from '@plugin/ea-bootstrap'
 ...
 * Optimism Gateway example: https://github.com/goplugin/ccip-read/tree/optimism-experimental/examples/optimism-metis-gateway
 *
 */
