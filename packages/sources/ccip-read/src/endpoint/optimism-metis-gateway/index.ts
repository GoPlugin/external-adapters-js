...
import { ExecuteWithConfig, InputParameters } from '@plugin/ea-bootstrap'
...
Currently this endpoint has the same functionality as the server in this example https://github.com/goplugin/ccip-read/tree/6d4deb917781f3becda39b9ebad6f21e037af1a6/examples/optimism-gateway.`
