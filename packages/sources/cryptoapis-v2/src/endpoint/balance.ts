...
import { AdapterInputError, Requester, util } from '@plugin/ea-bootstrap'
import type { Config, ExecuteFactory, AdapterData, InputParameters } from '@plugin/ea-bootstrap'
import {
  isCoinType,
  isChainType,
