...
import { AdapterResponse, makeLogger, sleep } from '@plugin/external-adapter-framework/util'
...
import { AdapterCustomError } from '@plugin/external-adapter-framework/validation/error'
