...
- [#3252](https://github.com/goplugin/external-adapters-js/pull/3252) [`732cf4c`](https://github.com/goplugin/external-adapters-js/commit/732cf4c4ecb7f9167e86a4a788d0ca88ebeab699) Thanks [@karen-stepanyan](https://github.com/karen-stepanyan)! - Changed API method from GET to POST for getting balances. Make sure that ETH Beacon API (ETH_CONSENSUS_RPC_URL) version is 2.5.0 or later.
...
- [#3178](https://github.com/goplugin/external-adapters-js/pull/3178) [`eeff213`](https://github.com/goplugin/external-adapters-js/commit/eeff213c555b0bb401afa6a8ef252861a490be25) Thanks [@amit-momin](https://github.com/amit-momin)! - Added env var default override to set MAX_PAYLOAD_SIZE_LIMIT to 5MB
