import { WebsocketReverseMappingTransport } from '@plugin/external-adapter-framework/transports'
import { ProviderResult, makeLogger } from '@plugin/external-adapter-framework/util'
