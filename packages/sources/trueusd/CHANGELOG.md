...
- e4c2675a0: Add 'chain' input parameter to filter data by blockchain
...
- 8161e1e18: make EA backwards compatible by supporting "field" field in request
