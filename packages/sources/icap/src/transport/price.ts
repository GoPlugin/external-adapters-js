...
import { WebSocketTransport } from '@plugin/external-adapter-framework/transports/websocket'
import { makeLogger, ProviderResult } from '@plugin/external-adapter-framework/util'
import { BaseEndpointTypes, GeneratePriceOptions } from '@plugin/tp-adapter'
