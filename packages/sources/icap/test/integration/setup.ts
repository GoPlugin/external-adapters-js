...
import tp from '@plugin/tp-adapter'
import {
  mockUSDCADResponse,
  mockTPPriceResponse,
...
import { ServerInstance } from '@plugin/external-adapter-framework'
 ...
 * fetching from this library to the \@plugin/ea-bootstrap package would access _another_ instance
