import { Validator, Logger, AdapterDataProviderError, util } from '@plugin/ea-bootstrap'
import type { AdapterRequest, ExecuteWithConfig, InputParameters } from '@plugin/ea-bootstrap'
import { ethers, BigNumber } from 'ethers'
import * as TokenAllocation from '@plugin/token-allocation-adapter'
