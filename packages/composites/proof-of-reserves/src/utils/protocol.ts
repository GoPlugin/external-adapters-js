...
// protocol adapters
import * as celsiusAddressList from '@plugin/celsius-address-list-adapter'
import * as chainReserveWallets from '@plugin/chain-reserve-wallet-adapter'
import { Adapter as v3AdapterImplementation } from '@plugin/external-adapter-framework/adapter'
import { adapter as gemini } from '@plugin/gemini-adapter'
import { adapter as moonbeamAddressList } from '@plugin/moonbeam-address-list-adapter'
import { adapter as porAddressList } from '@plugin/por-address-list-adapter'
import * as renVM from '@plugin/renvm-address-set-adapter'
import { adapter as staderList } from '@plugin/stader-address-list-adapter'
import * as swellList from '@plugin/swell-address-list-adapter'
import { adapter as wBTC } from '@plugin/wbtc-address-set-adapter'
import * as wrapped from '@plugin/wrapped-adapter'
import { adapter as coinbasePrime } from '@plugin/coinbase-prime-adapter'
import { adapter as multiAddressList } from '@plugin/multi-address-list-adapter'
import { adapter as ignitionAddressList } from '@plugin/ignition-address-list-adapter'
