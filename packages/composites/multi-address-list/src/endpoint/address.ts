...
import { walletParameters as anchorageParams } from '@plugin/anchorage-adapter'
import { walletParameters as coinbasePrimeParams } from '@plugin/coinbase-prime-adapter'
import { walletParameters as bitGoParams } from '@plugin/bitgo-adapter'
