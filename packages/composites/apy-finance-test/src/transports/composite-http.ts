...
import { calculateHttpRequestKey } from '@plugin/external-adapter-framework/cache'
import {
  TransportDependencies,
  TransportGenerics,
} from '@plugin/external-adapter-framework/transports'
...
import { TypeFromDefinition } from '@plugin/external-adapter-framework/validation/input-params'
