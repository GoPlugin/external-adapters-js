...
import * as view from '@plugin/terra-view-function-adapter'
import { AdapterResponseInvalidError } from '@plugin/ea-bootstrap'
...
export const getTokenPrice = async (
  ...
  throwErrorForInvalidResult(input.id, result, `Plugin Terra feed ${feedAddress}`)
  return result
}
