import { AdapterRequest, FastifyInstance } from '@plugin/ea-bootstrap'
...
import '@plugin/terra-view-function-adapter'
...
jest.mock('@plugin/terra-view-function-adapter', () => {
  return {
    ...jest.requireActual('@plugin/terra-view-function-adapter'),
