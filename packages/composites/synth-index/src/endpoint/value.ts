import { AdapterInputError, Validator } from '@plugin/ea-bootstrap'
import * as ta from '@plugin/token-allocation-adapter'
import { InputParameters, ExecuteWithConfig } from '@plugin/ea-bootstrap'
...
const inputParameters: InputParameters<TInputParameters> = {
  ...
  network: {
    description: 'Network to fetch the Synth Index',
    required: false,
  },
  quote: {
    description: 'Currency that we want the price on',
    required: false,
  },
}
