import * as IPFS_Adapter from '@plugin/ipfs-adapter'
import { types } from '@plugin/ipfs-adapter'
import {
...
import { TInputParameters } from '@plugin/ipfs-adapter/dist/endpoint/read'
