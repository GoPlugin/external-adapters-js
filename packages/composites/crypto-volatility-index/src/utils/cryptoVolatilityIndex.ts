import { Logger } from '@plugin/ea-bootstrap'
import { getRpcLatestRound } from '@plugin/ea-reference-data-reader'
...
import type { AdapterContext, AdapterRequest, AdapterRequestData } from '@plugin/ea-bootstrap'
